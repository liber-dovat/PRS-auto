...
# PROGRAMAS
main='/sat/PRS/dev/PRS-sat/PRSbaseMultiproc/PRSsat_auto_VIS';
libs='/sat/PRS/dev/PRS-sat/PRSbaseMultiproc/lib_PRSsat';
#main='/sat/PRS/libs/PRS-sat/PRSbase/PRSsat_auto_VIS';
#libs='/sat/PRS/libs/PRS-sat/PRSbase/lib_PRSsat';

# PARAMETROS
folders='/sat/PRS/dev/PRS-sat/data/job_folders_ALL1';
spatial='/sat/PRS/dev/PRS-sat/data/job_spatial_VIS1';
