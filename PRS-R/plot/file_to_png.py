...
def fileToPng(file, metaPath, colormapPath, colormapName, outPngPath):
  ...
  # fid = open('/home/chrono/Escritorio/graficas/PRS-R/data/vec/T000gri.chr.LATvec', 'r')
  ...
  # fid = open('/home/chrono/Escritorio/graficas/PRS-R/data/vec/T000gri.chr.LONvec', 'r')
  ...
  fid  = open(file, 'r')
  # fid  = open("/home/chrono/Escritorio/graficas/PRS-R/data/vec/T000gri.chr.Data.FR", 'r')
  data = numpy.fromfile(fid, dtype='float32')
  fid.close()

  print LATdeg_vec.shape
  print LONdeg_vec.shape
  print data.shape

  # x = numpy.reshape(LONdeg_vec, (Ci, Cj))
  # y = numpy.reshape(LATdeg_vec, (Ci, Cj))
  ...
  ax = Basemap(projection='merc',\
                llcrnrlat=-44.0,urcrnrlat=-21.0,\
                llcrnrlon=-68.0,urcrnrlon=-44.0,\
                resolution='f')

  # ax = Basemap(projection='merc',\
  #               llcrnrlat=-47.8426265,urcrnrlat=35.6702423,\
  #               llcrnrlon=-104.5043545,urcrnrlon=-21.5380542,\
  #               resolution='f')
  ...
  mer = ax.drawmeridians(numpy.arange(-70, -40, 5), labels=[0,0,1,0], linewidth=0.0, fontsize=10, color='white')

  setcolor(par,'white')
  setcolor(mer,'white')

  # LONdeg_vec_shape = numpy.reshape(LONdeg_vec, (Ci, Cj))
  # LATdeg_vec_shape = numpy.reshape(LATdeg_vec, (Ci, Cj))
  # print LONdeg_vec_shape.shape
  # print LATdeg_vec_shape.shape

  # genero un meshgrid a partir de LonVec y LatVec
  lons2d, lats2d = numpy.meshgrid(LONdeg_vec, LATdeg_vec)
  # print dim(LONdeg_vec)
  # print dim(LATdeg_vec)
  ...
  # print str(x[0][0]) + " " + str(y[0][0]) + " " + str(IMG[0][0])
  ...
  plt.savefig(destFile, bbox_inches='tight', dpi=600, transparent=True)
