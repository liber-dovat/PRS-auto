...
def FnFunc(gamma):
  DELTArad = 1.000110 + 0.001280*math.sin(gamma) + 0.000077*math.sin(2*gamma) + 0.034221*math.cos(gamma) + 0.000719*math.cos(2*gamma);
...
def cosSolarZenithAngle(phi, psi, datetime, gmt):
  # phi = lat <ubicacion>
  # psi = lon <ubicacion>
  ...
  hora_solar = hora_local + (psi-gmt*15)/15.0 + E/60.0 # psi en grados
