...
# PROGRAMAS
main='/rolo/Wsate/PRS/server-sat-01/libs/PRS-sat/PRSbase/PRSbase_VIS_test';
...
spatial='/rolo/Wsate/PRS/server-sat-01/libs/PRS-sat/PRSbase/data/job_spatial_VIS_test';
imglist='/rolo/Wsate/PRS/server-sat-01/libs/PRS-sat/PRSbase/data/job_imglist_VIS_test';
